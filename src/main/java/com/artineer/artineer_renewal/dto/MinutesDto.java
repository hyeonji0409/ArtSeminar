...
public class MinutesDto {
    ...
    @Builder
    public MinutesDto(Long no, String title, String story, int hit, String username, String name,int year, String regdate, List<String> file, List<Comment> comments) {
        this.no = no;
        this.title = title;
        this.story = story;
        this.hit = hit;
